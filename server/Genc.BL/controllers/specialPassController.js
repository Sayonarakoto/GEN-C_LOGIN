const SpecialPass = require('../../Genc.DAL/models/SpecialPass'); // D1
const AuditLog = require('../../Genc.DAL/models/AuditLog'); // D2
const Student = require('../../Genc.DAL/models/student'); // To get student's department
